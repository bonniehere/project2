	...
	<script>
			...
			class JSONAdd{
				...
				public JSONAdd(){
					...
					floor1.put("35.54254097826589, 129.3357961417249", "문과");
					floor1.put("35.5424227812333, 129.33724520256774", "이과");

					JSONObject floor2 = new JSONObject();
					floor2.put("35.54254097826589, 129.3357961417249", "사과");
					floor2.put("35.5424227812333, 129.33724520256774", "배");

					
					//위에서 만든 3개의 오브젝트 데이터를 JSONArray에 순서대로 저장
					JSONArray arr = new JSONArray();
					arr.add(floor1);//0번인덱스
					arr.add(floor2);//1번인덱스
