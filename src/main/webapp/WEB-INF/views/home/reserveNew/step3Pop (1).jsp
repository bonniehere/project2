...
<form id="frm" name="frm" method="POST">
	...
	<!-- 시간 정보 -->
	<input type="hidden" id="schYear" name="schYear" value="2023"> <!-- 년 -->
	<input type="hidden" id="schMonth" name="schMonth" value="12"> <!-- 월 -->
	<input type="hidden" id="schDate" name="schDate" value=""> <!-- 일 -->
	<input type="hidden" id="resvDd" name="resvDd" value=""> <!-- 년+월+일 -->
	<input type="hidden" id="resvHh" name="resvHh" value=""> <!-- 시간 -->
   <!-- 진료예약 -->
       ...
       <div class="inner">
           ...
           <div class="reservation_content">
               ...
               <div class="content_wrap">
                   ...
                   <!-- 여기  calendarForm div 안이 캘린더 들어가는 곳임-->
